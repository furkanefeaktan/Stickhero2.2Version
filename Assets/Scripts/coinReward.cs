   ...
   public void CountCoins()
    {
        ...
        for (int i = 0; i < pileOfCoins.transform.childCount; i++)
        {
            ...
            MoneyValueText.transform.parent.GetChild(0).transform.DOScale(1.1f, 0.1f).SetLoops(10,LoopType.Yoyo).SetEase(Ease.InOutSine).SetDelay(1.2f);
        }
    ...
    IEnumerator CountDollars()
    {
        ...
        MoneyValueText.text = PlayerPrefs.GetInt("CountDollar").ToString();
